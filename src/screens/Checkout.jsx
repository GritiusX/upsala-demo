...
export default function Checkout({ navigate }) {
  ...
  return (
    <main className="pt-16 min-h-screen bg-surface">
      ...
      <div className="flex flex-col w-full px-margin-mobile gap-lg pb-safe">
        <div className="flex flex-col gap-base pt-lg text-center">
          <h1 className="font-headline-lg-mobile text-headline-lg-mobile text-on-surface">Completa tu Aventura</h1>
